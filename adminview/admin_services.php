<?php /*
    ...
    $get_serv_sql = "SELECT * FROM services_tb";

    $get_serv_query = mysqli_query($conn, $get_serv_sql);*/
?>
					...
					<div class="col-md-10">
						...
						<div class="table-responsive">
							<table id="table1" class="table table-striped table-md table-hover table-bordered">
								...
								<tbody>
                                    <?php  $n = 0; foreach ($services as $serv): $n++ ?>
										<tr>
											<td><?= $n ?></td>
											<td>
												<b style="text-shadow: 	-1px -1px 0 white,
																	...
																	1px  1px 0 white;"
												>
													<?= $serv['serv_serve']."</br><small>".$serv['serv_price']. "</small>"?>
												</b>
											</td>
											<td style="text-align: justify;"><?= $serv['serv_detail'] ?> </td>
											<td align="center">
												<button class="btn btn-primary btn-sm" 
												   title="UPDATE SERVICES FEATURE" 
												   data-toggle="modal"
												   data-target="#update_serv_<?= $serv['serv_id']?>"
												   >
													<span class="fa fa-edit" title="UPDATE SERVICES FEATURE"></span>
												</button>
											</td>
										</tr>
												...
												<div class="modal-content">
													<form action="../page/admin.php?function=serveBtn&subpage=admin_services" method="post">
																...
																<div class="p-4 p-md-5 border rounded-3 bg-light">
																	<div class="form-floating mb-3">
																		<div class="row">
																			...
																			<input type="hidden" value="<?= $serv['serv_id'] ?>" name="id">
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="modal-footer">
															...
															<button type="submit" class="btn btn-success btn-sm" name="serveBtn"><span class="fa fa-save"></span></button>
														</div>
													</form>
												</div>
											</div>
