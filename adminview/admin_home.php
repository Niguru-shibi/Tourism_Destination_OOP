...
//Album Query
$get_alb_sql = "SELECT * FROM album_tb";

$get_alb_query = mysqli_query($conn, $get_alb_sql);

//Feature Query
$get_ft_sql = "SELECT * FROM feature_tb";

$get_ft_query = mysqli_query($conn, $get_ft_sql);*/
		...
		<div class="row">
			<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
				<div class="sidebar-sticky pt-3">
					...
					<ul class="nav flex-column">
						<li class="nav-item">
							<a class="nav-link active" href="?subpage=dashboard">
						...
						<li class="nav-item">
							<a class="nav-link " href="?subpage=inquiry">
					...
					<ul class="nav flex-column mb-2">
						<li class="nav-item">
							<a class="nav-link  "href="?subpage=admin_home">
						...
						<li class="nav-item">
							<a class="nav-link" href="?subpage=admin_services">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
								Services
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="?subpage=admin_contact">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
								Contact
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="?subpage=admin_footer">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
								Footer
							</a>
						</li>
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<div class="row justify-content-center">
					<div class="col-md-10">
						<h2>Featured Album Destination</h2>
						<div class="table-responsive">
							<table id="table1" class="table table-striped table-md table-hover table-bordered">
								...
								<tbody>
									<?php  $n = 0; foreach ($album as $alb): $n++ ?>
										<tr>
											<td><?= $n ?></td>
											<td style="
												background-image:url(<?= $alb['alb_img'] ?>);
												...
												<b style="text-shadow: 	-1px -1px 0 white,
																	...
																	1px  1px 0 white;"
												>
													<?= $alb['alb_title']."</br><small>".$alb['alb_subTitle']. "</small>"?>
												</b>
											</td>
											<td style="text-align: justify;"><?= $alb['alb_description'] ?> </td>
											<td align="center">
												<button class="btn btn-primary btn-sm" 
												   title="UPDATE ALBUM FEATURE" 
												   data-toggle="modal"
												   data-target="#update_alb_<?= $alb['alb_id']?>"
												   >
													<span class="fa fa-edit" title="UPDATE ALBUM FEATURE"></span>
												</button>
											</td>
										</tr>
												...
												<div class="modal-content">
													<form action="process_data.php?page=admin_home" method="post">
																...
																<div class="p-4 p-md-5 border rounded-3 bg-light">
																	<div class="form-floating mb-3">
																		<div class="row">
																			...
																			<input type="hidden" value="<?= $alb['alb_id'] ?>" name="id">
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="modal-footer">
															<button type="button" class="btn btn-warning btn-sm" data-dismiss="modal"><span class="fa fa-trash"></span></button>
															<button type="submit" class="btn btn-success btn-sm" name="albumBtn"><span class="fa fa-save"></span></button>
														</div>
													</form>
												</div>
											</div>
					...
					<div class="col-md-10">
						...
						<div class="table-responsive">
							<table id="table2" class="table table-striped table-md table-hover table-bordered">
								...
								<tbody>
									<?php  $n = 0; foreach ($feature as $ft): $n++ ?>
										<tr>
											<td><?= $n ?></td>
											<td style="
												background-image:url(<?= $ft['ft_img'] ?>);
												background-size:cover;
												background-position: center;
												background-repeat: no-repeat
												">
												<b style="text-shadow: 	-1px -1px 0 white,
																	...
																	1px  1px 0 white;"
												>
													<?= $ft['ft_title']."</br><small>".$ft['ft_subTitle']. "</small>"?>
												</b>
											</td>
											<td style="text-align: justify;"><?= $ft['ft_description'] ?> </td>
											<td align="center">
												<button class="btn btn-primary btn-sm" 
												   title="UPDATE FEATURE" 
												   data-toggle="modal"
												   data-target="#update_ft_<?= $ft['ft_id']?>"
												   >
													<span class="fa fa-edit" title="UPDATE FEATURE"></span>
												</button>
											</td>
										</tr>
											...
											<div class="modal-dialog" style="max-width:700px;">
												<div class="modal-content">
													<form action="process_data.php?page=admin_home" method="post">
																...
																<div class="p-4 p-md-5 border rounded-3 bg-light">
																	<div class="form-floating mb-3">
																		<div class="row">
																			...
																			<input type="hidden" value="<?= $ft['ft_id'] ?>" name="id">
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="modal-footer">
															<button type="button" class="btn btn-warning btn-sm" data-dismiss="modal"><span class="fa fa-trash"></span></button>
															<button type="submit" class="btn btn-success btn-sm" name="featureBtn"><span class="fa fa-save"></span></button>
														</div>
													</form>
												</div>
											</div>
